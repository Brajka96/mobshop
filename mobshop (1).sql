...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2019 at 11:06 PM
...
INSERT INTO `korisnik` (`ID`, `IME`, `PREZIME`, `EMAIL`, `KORISNICKO_IME`, `SIFRA`, `USER_TYPE`) VALUES
(1, 'Admin', 'Admin', 'admin@gmail.com', 'admin', 'admin', 'admin'),
(2, 'Josip', 'Brajkovic', 'brajka55@gmail.com', 'brajka', 'brajka', 'user'),
(3, 'Ante', 'Bule', 'bule@gmail.com', 'bule', 'bule', 'user'),
(4, 'Josip', 'Pasalic', 'josip@gmail.com', 'josip', 'josip', 'user'),
(5, 'Petar', 'Grubisic', 'petar@gmail.com', 'petar', 'petar', 'user'),
(6, 'novi', 'korisnik', 'novi@novi.com', 'novi', 'novi', 'user');
...
--
ALTER TABLE `uredaji`
  MODIFY `uredaj_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
COMMIT;
